...
-   `app/rag/protocols.py`: Interface definitions
-   `app/rag/factory.py`: Component wiring & creation
-   `app/rag/routes.py`: API endpoints
-   `app/rag/services/`: Business logic implementations
...
-   **Analysis**
    ...
    -   **Implementation**: `LLMQueryAnalyzer`
    -   **Purpose**: Extract keywords & intent
-   **Expansion**
    -   **Protocol**: `QueryAnalyzer`
    -   **Implementation**: `LLMQueryAnalyzer`
...
-   **Retrieval**
    -   **Protocol**: `Retriever`
    -   **Implementation**: `PipelineRetriever`
    -   **Purpose**: Orchestrate search & context building
-   **Reasoning**
    -   **Protocol**: `GraphRetriever`
    -   **Implementation**: `GraphRetrieverService`
    -   **Purpose**: Expand context via Neo4j
-   **Reranking**
    -   **Protocol**: `Reranker`
    -   **Implementation**: `CrossEncoderReranker`
    -   **Purpose**: Re-score results using CrossEncoder
-   **Generation**
    -   **Protocol**: `GenerativeModel`
    -   **Implementation**: `OpenAIGenerator`
...
-   **Source**:
    -   [factory.py](../app/rag/factory.py)
    -   [retrieval.py](../app/rag/services/retrieval.py)
